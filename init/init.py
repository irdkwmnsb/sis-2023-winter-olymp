...
c_adult.save()
r0 = make_resource(id=1,name='пушка',name_acc_one='пушку',name_acc_two='пушки',name_acc_five='пушек')
r1 = make_resource(id=2,name='катапульта',name_acc_one='катапульту',name_acc_two='катапульты',name_acc_five='катапульт')
